...
const formSchema = z.object({
    ...
    password: z.string().optional(), // Make optional for now to support old accounts without password, or strict? Let's make it optional in schema but input is there.
});
