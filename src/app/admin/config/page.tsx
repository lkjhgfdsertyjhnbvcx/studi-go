    ...
    return (
        <div className="min-h-screen bg-black text-white p-10 font-sans">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-5xl font-bold mb-10 tracking-normal">Admin Config</h1>
                <div className="bg-zinc-900 p-10 rounded-[3rem] border border-zinc-800 shadow-2xl">
                    ...
                    <button onClick={save} disabled={loading} className="w-full mt-8 py-6 bg-purple-800 rounded-[2.5rem] font-bold text-xl hover:bg-white hover:text-black transition-all">
