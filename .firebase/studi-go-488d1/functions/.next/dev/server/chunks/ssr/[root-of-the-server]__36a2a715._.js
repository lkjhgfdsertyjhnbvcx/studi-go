...
;
;
const PAYMENTS_DB_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "data", "payments.json");
// Initialize payments DB
if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(PAYMENTS_DB_PATH)) {
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(PAYMENTS_DB_PATH, JSON.stringify([], null, 2));
}
async function fetchPayments() {
    try {
        const data = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(PAYMENTS_DB_PATH, "utf-8");
...
async function sendReminderEmail(paymentId, email) {
    ...
    console.log(`Sending reminder email to ${email} for payment ${paymentId}`);
    ...
    //   to: email,
    //   subject: 'お支払いのご確認',
    //   html: '<p>お支払いが確認できておりません。ご確認をお願いいたします。</p>'
    // });
    return {
        success: true
    };
...
async function createPayment(data) {
    ...
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(PAYMENTS_DB_PATH, JSON.stringify(payments, null, 2));
    return {
        success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36a2a715._.js.map