...
const getBookings = async ()=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$firestore$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllBookingsFromFirestore"])();
};
const getBookingById = async (id)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$firestore$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBookingByIdFromFirestore"])(id);
};
const saveBooking = async (booking)=>{
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$firestore$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveBookingToFirestore"])(booking);
};
const updateBooking = async (id, updates)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$firestore$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateBookingInFirestore"])(id, updates);
};
const checkAvailability = async (studioId, roomName, date, startTime, duration, excludeBookingId)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$firestore$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkAvailabilityFromFirestore"])(studioId, roomName, date, startTime, duration, excludeBookingId);
};
}),
"[project]/music-studio-app/src/actions/admin.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"00a68c4314eb908d52d8300c546165c38d9396948b":"fetchBookings","40711a429c985a6caa883c71953552fd7b21e6bbf9":"fetchBookingsByStudio","608ba7991e12b182ca12b25d2660f06ee1dfa8c61b":"updateBookingStatus"},"",""] */ __turbopack_context__.s([
    "fetchBookings",
    ()=>fetchBookings,
...
async function fetchBookings() {
    ...
    const bookings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$local$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBookings"])();
    return bookings.sort((a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
}
async function fetchBookingsByStudio(studioId) {
    const allBookings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$local$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBookings"])();
...
async function updateBookingStatus(id, status) {
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$db$2d$local$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateBooking"])(id, {
        status
    });
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateBookingStatus, "608ba7991e12b182ca12b25d2660f06ee1dfa8c61b", null);
}),
"[project]/music-studio-app/.next-internal/server/app/admin/(protected)/page/actions.js { ACTIONS_MODULE0 => \"[project]/music-studio-app/src/actions/admin-auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/music-studio-app/src/actions/studio.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/music-studio-app/src/actions/admin.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/music-studio-app/.next-internal/server/app/admin/(protected)/page/actions.js { ACTIONS_MODULE0 => \"[project]/music-studio-app/src/actions/admin-auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/music-studio-app/src/actions/studio.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/music-studio-app/src/actions/admin.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "608ba7991e12b182ca12b25d2660f06ee1dfa8c61b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$actions$2f$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateBookingStatus"],
...
//# sourceMappingURL=music-studio-app_0834b98e._.js.map