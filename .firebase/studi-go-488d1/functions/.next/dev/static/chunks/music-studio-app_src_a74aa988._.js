...
const PhysicsHero = ({ onBookingTrigger, studioName, appealPoint })=>{
    _s();
    const { primaryColor, backgroundImage, backgroundColor, logoUrl } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$theme$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const scrollToRooms = ()=>{
...
_s(PhysicsHero, "govj7vpbS5+cb/2ov66/3r1M94A=", false, function() {
    return [
...
//# sourceMappingURL=music-studio-app_src_a74aa988._.js.map