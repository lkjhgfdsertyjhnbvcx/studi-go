...
const BookingModal = ({ isOpen, onOpenChange, studioData, initialRoomIndex, initialDate, initialTime, initialDuration })=>{
    ...
    const handleBooking = async ()=>{
        ...
        const appUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$actions$2f$data$3a$e78e49__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCurrentUser"])();
...
function RoomSchedulePage() {
        ...
        "RoomSchedulePage.useEffect": ()=>{
            const load = {
                "RoomSchedulePage.useEffect.load": async ()=>{
                    const sData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$actions$2f$data$3a$6e4704__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["fetchStudio"])(storeId);
                    if (!sData) return;
                    setStudio(sData);
    ...
    const { backgroundColor, backgroundImage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$music$2d$studio$2d$app$2f$src$2f$lib$2f$theme$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
...
_s(RoomSchedulePage, "9gd8+/NuwN+reOwP2w65vuQcRJA=", false, function() {
    return [
...
//# sourceMappingURL=music-studio-app_src_0568e1b8._.js.map